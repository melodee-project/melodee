...
namespace Melodee.Common.Migrations
{
    ...
    [Migration("20260119220442_AddRadioStationJobSettings")]
    partial class AddRadioStationJobSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Melodee.Common.Data.Models.RadioStation", b =>
                {
                    ...
                    b.Property<int?>("LastBitrateKbps")
                        .HasColumnType("integer");
                    ...
                    b.Property<Instant?>("LastHealthCheckAt")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.Property<Instant?>("LastHealthOkAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int>("LastHealthStatus")
                        .HasColumnType("integer");

                    b.Property<string>("LastResolvedStreamUrl")
                        .HasMaxLength(2000)
                        .HasColumnType("character varying(2000)");
                    ...
                    b.Property<string>("LogoCacheKey")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.Property<Instant?>("NowPlayingCapturedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("NowPlayingRaw")
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
            ...
            modelBuilder.Entity("Melodee.Common.Data.Models.RadioStationNowPlayingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RadioStationId", "CapturedAt");

                    b.ToTable("RadioStationNowPlayingHistories");
                });

            modelBuilder.Entity("Melodee.Common.Data.Models.RadioStationUserPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("UserId", "RadioStationId")
                        .IsUnique();

                    b.ToTable("RadioStationUserPreferences");
                });
            ...
            modelBuilder.Entity("Melodee.Common.Data.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1928,
                            ApiKey = new Guid("1e9aff97-edef-3730-9660-b405005417c2"),
                            Category = 14,
                            Comment = "Cron expression to run the radio station health probe job, set empty to disable. Default of '0 */15 * ? * *' runs every 15 minutes.",
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(0L),
                            IsLocked = false,
                            Key = "jobs.radioStationHealthProbe.cronExpression",
                            SortOrder = 0,
                            Value = "0 */15 * ? * *"
                        },
                        new
                        {
                            Id = 1929,
                            ApiKey = new Guid("4d84ca71-d6f3-a448-4aae-fff832acf0d6"),
                            Category = 14,
                            Comment = "Cron expression to run the radio station now-playing capture job, set empty to disable. Default of '0 */5 * ? * *' runs every 5 minutes.",
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(0L),
                            IsLocked = false,
                            Key = "jobs.radioStationNowPlayingCapture.cronExpression",
                            SortOrder = 0,
                            Value = "0 */5 * ? * *"
                        },
                        new
                        {
                            Id = 1930,
                            ApiKey = new Guid("d8b0e586-7ec5-8ae1-0e0f-5bdc9cc17fdc"),
                            Category = 14,
                            Comment = "Cron expression to run the radio station now-playing history cleanup job, set empty to disable. Default of '0 0 3 ? * *' runs daily at 3 AM.",
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(0L),
                            IsLocked = false,
                            Key = "jobs.radioStationNowPlayingHistoryCleanup.cronExpression",
                            SortOrder = 0,
                            Value = "0 0 3 ? * *"
                        });
                });
            ...
            modelBuilder.Entity("Melodee.Common.Data.Models.RadioStationNowPlayingHistory", b =>
                {
                    b.HasOne("Melodee.Common.Data.Models.RadioStation", "RadioStation")
                        .WithMany()
