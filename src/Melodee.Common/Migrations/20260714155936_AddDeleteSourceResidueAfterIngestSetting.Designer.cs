...
namespace Melodee.Common.Migrations
{
    ...
    [Migration("20260714155936_AddDeleteSourceResidueAfterIngestSetting")]
    partial class AddDeleteSourceResidueAfterIngestSetting
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Melodee.Common.Data.Models.Setting", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 55,
                            ApiKey = new Guid("3225bc34-a416-3dc3-dd9c-5a4a5e592189"),
                            Comment = "Delete leftover residue (logs, sidecars, images, failed transcodes) from media-free release directories after ingest, even when keeping the original media (copy mode). Defaults on.",
                            CreatedAt = NodaTime.Instant.FromUnixTimeTicks(0L),
                            IsLocked = false,
                            Key = "processing.deleteSourceResidueAfterIngest",
                            SortOrder = 0,
                            Value = "true"
                        },
                        new
